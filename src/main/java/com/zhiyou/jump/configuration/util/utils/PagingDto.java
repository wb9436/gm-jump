...
public class PagingDto extends DTO {
    ...
    private static final int DEFALUT_PAGES_SHOW = 10;
    ...
    public String toString() {
        return "PagingDto [totalRows=" + totalRows + ", startRowIndex=" + startRowIndex + ", endRowIndex=" + endRowIndex + ", curPageNum=" + curPageNum + ", totalPageNum="
                        + totalPageNum + ", pageSize=" + pageSize + ", pageNumArray=" + Arrays.toString(pageNumArray) + ", isLast=" + isLast + ", isFirst=" + isFirst + "]";
    }
}
